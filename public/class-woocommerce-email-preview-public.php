 ...
 * @subpackage Woocommerce_Email_Preview/public
 */
 ...
 */
class Woocommerce_Email_Preview_Public
{
    /**
    ...
    public function enqueue_styles()
    {
        ...
        wp_enqueue_style($this->plugin_name, plugin_dir_url(__FILE__) . 'css/woocommerce-email-preview-public.css', [], $this->version, 'all');
    }
