...
class Woocommerce_Email_Preview
{
    ...
    {
        if (defined('WOOCOMMERCE_EMAIL_PREVIEW_VERSION')) {
            $this->version = WOOCOMMERCE_EMAIL_PREVIEW_VERSION;
        } else {
            $this->version = '1.0.0';
        }
    ...
    {
        $plugin_i18n = new Woocommerce_Email_Preview_i18n();
    ...
    {
        $plugin_admin = new Woocommerce_Email_Preview_Admin($this->get_plugin_name(), $this->get_version());
